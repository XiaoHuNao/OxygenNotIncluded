	...
	public static RenderType gasTranslucent() {
		if (GAS_TRANSLUCENT == null) {
            RenderType.CompositeState state = RenderType.CompositeState.builder()
                .setShaderState(new RenderStateShard.ShaderStateShard(() -> ShaderRegistry.GAS_SHADER))
            ...
            GAS_TRANSLUCENT = RenderType.create("oni_gas_translucent",
                DefaultVertexFormat.POSITION_COLOR_TEX_LIGHTMAP, VertexFormat.Mode.TRIANGLES, 256,
				true, true, state);
		}
